...
void UFPDirectionIndicator::SetEventManager(UFPGlobalEventManager* InEventManager)
{
	Super::SetEventManager(InEventManager);

	EventManager->SetTargetLocation.BindUObject(this, &UFPDirectionIndicator::SetTargetLocation);
}
